...
class DownloadWorkManagerImpl constructor(
  ...
  private val urls = LinkedList(listOf("PlanDefinition","Library", "StructureMap", "Questionnaire", "StructureDefinition", "ValueSet", "OperationDefinition", "Patient", "Encounter", "Observation", "RelatedPerson", "Binary", "ActivityDefinition"))
