...
import com.argusoft.who.emcare.databinding.PatientDetailsCardViewBinding
import com.argusoft.who.emcare.databinding.PatientDetailsHeaderBinding
import com.argusoft.who.emcare.databinding.PatientListItemViewBinding
import com.google.android.material.shape.MaterialShapeDrawable
import com.google.android.material.shape.RoundedCornerTreatment
import com.google.android.material.shape.ShapeAppearanceModel

class PatientDetailsRecyclerViewAdapter(private val onDeletePatientClick: () -> Unit) :
...
class PatientOverviewItemViewHolder(
  ...
  val onDeletePatientClick: () -> Unit
) : PatientDetailItemViewHolder(binding.root) {
  override fun bind(data: PatientDetailData) {
    binding.deletePatient.setOnClickListener { onDeletePatientClick() }
