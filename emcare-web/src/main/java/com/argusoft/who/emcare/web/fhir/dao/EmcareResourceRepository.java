...
public interface EmcareResourceRepository extends JpaRepository<EmcareResource, Integer> {
    ...
    @Query(value = "\n" +
        ...
        "LEFT OUTER JOIN MAX_CONSULTATION_DATE ON EMCARE_RESOURCES.RESOURCE_ID = MAX_CONSULTATION_DATE.PATIENT_ID\n" +
        "LEFT JOIN LOCATION_RESOURCES ON EMCARE_RESOURCES.facility_id = LOCATION_RESOURCES.resource_id \n" +
        "where EMCARE_RESOURCES.FACILITY_ID in :ids and EMCARE_RESOURCES.created_on between :startDate and :endDate ORDER BY EMCARE_RESOURCES.created_on DESC limit 10 offset :offset", nativeQuery = true)
    ...
    @Query(value = "\n" +
        ...
        "LEFT OUTER JOIN MAX_CONSULTATION_DATE ON EMCARE_RESOURCES.RESOURCE_ID = MAX_CONSULTATION_DATE.PATIENT_ID\n" +
        "LEFT JOIN LOCATION_RESOURCES ON EMCARE_RESOURCES.facility_id = LOCATION_RESOURCES.resource_id \n" +
        "where EMCARE_RESOURCES.FACILITY_ID in :ids and EMCARE_RESOURCES.created_on between :startDate and :endDate ORDER BY EMCARE_RESOURCES.created_on DESC", nativeQuery = true)
    ...
    @Query(value = "\n" +
        ...
        "LEFT OUTER JOIN MAX_CONSULTATION_DATE ON EMCARE_RESOURCES.RESOURCE_ID = MAX_CONSULTATION_DATE.PATIENT_ID\n" +
        "LEFT JOIN LOCATION_RESOURCES ON EMCARE_RESOURCES.facility_id = LOCATION_RESOURCES.resource_id \n" +
        "where EMCARE_RESOURCES.created_on between :startDate and :endDate ORDER BY EMCARE_RESOURCES.created_on DESC limit 10 offset :offset", nativeQuery = true)
    ...
    @Query(value = "\n" +
        ...
        "LEFT OUTER JOIN MAX_CONSULTATION_DATE ON EMCARE_RESOURCES.RESOURCE_ID = MAX_CONSULTATION_DATE.PATIENT_ID\n" +
        "LEFT JOIN LOCATION_RESOURCES ON EMCARE_RESOURCES.facility_id = LOCATION_RESOURCES.resource_id \n" +
        "where EMCARE_RESOURCES.created_on between :startDate and :endDate ORDER BY EMCARE_RESOURCES.created_on DESC", nativeQuery = true)
    ...
    @Query(value = "WITH MAX_CONSULTATION_DATE AS\n" +
            ...
            "\t   cast((EMCARE_RESOURCES.text) as json) ->> cast('gender' as text) ilike concat('%',:searchString,'%') or\n" +
            "\t   cast((EMCARE_RESOURCES.text) as json) ->> cast('birthDate' as text) ilike concat('%',:searchString,'%') or\n" +
            "\t   cast((LOCATION_RESOURCES.text) as json) ->> cast('name' as text) ilike concat('%',:searchString,'%')) ORDER BY EMCARE_RESOURCES.created_on DESC",nativeQuery = true)
    ...
    @Query(value = "WITH MAX_CONSULTATION_DATE AS\n" +
            ...
            "\t   cast((EMCARE_RESOURCES.text) as json) ->> cast('gender' as text) ilike concat('%',:searchString,'%') or\n" +
            "\t   cast((EMCARE_RESOURCES.text) as json) ->> cast('birthDate' as text) ilike concat('%',:searchString,'%') or\n" +
            "\t   cast((LOCATION_RESOURCES.text) as json) ->> cast('name' as text) ilike concat('%',:searchString,'%')) ORDER BY EMCARE_RESOURCES.created_on DESC limit 10 offset :offset",nativeQuery = true)
