...
public class PlanDefinitionResourceProvider implements IResourceProvider {
    ...
    @Search()
    public List<PlanDefinition> getAllPlanDefinition(@OptionalParam(name = CommonConstant.RESOURCE_LAST_UPDATED_AT) DateParam theDate) {
        return planDefinitionResourceService.getAllPlanDefinition(theDate);
    }
    ...
    @Search()
    public Bundle getPlanDefinitionCountBasedOnDate(@RequiredParam(name = CommonConstant.SUMMARY) String type, @OptionalParam(name = CommonConstant.RESOURCE_LAST_UPDATED_AT) DateParam theDate) {
        return planDefinitionResourceService.getPlanDefinitionCountBasedOnDate(type, theDate);
    }
}
