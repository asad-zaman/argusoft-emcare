...
@Entity
@Table(name = "structure_map_resource")
public class StructureMapResource extends EntityAuditInfo implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StructureMapResource)) return false;
        if (!super.equals(o)) return false;
        StructureMapResource that = (StructureMapResource) o;
